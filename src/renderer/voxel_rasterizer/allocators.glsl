...
uint allocate_meshlets(daxa_RWBufferPtr(VoxelMeshlet) meshlet_allocator, uint meshlet_n, bool compute_raster) {
    daxa_RWBufferPtr(VoxelMeshletAllocatorState) allocator_state = daxa_RWBufferPtr(VoxelMeshletAllocatorState)(as_address(meshlet_allocator));
    if (compute_raster) {
...
bool is_valid_meshlet_index(daxa_BufferPtr(VoxelMeshlet) meshlet_allocator, uint meshlet_i) {
    daxa_BufferPtr(VoxelMeshletAllocatorState) allocator_state = daxa_BufferPtr(VoxelMeshletAllocatorState)(as_address(meshlet_allocator));
...
uint allocate_brick_instances(daxa_RWBufferPtr(BrickInstance) brick_instance_allocator, uint brick_instance_n) {
    daxa_RWBufferPtr(BrickInstanceAllocatorState) allocator_state = daxa_RWBufferPtr(BrickInstanceAllocatorState)(as_address(brick_instance_allocator));
...
bool is_valid_index(daxa_BufferPtr(BrickInstance) brick_instance_allocator, uint brick_instance_i) {
    daxa_BufferPtr(BrickInstanceAllocatorState) allocator_state = daxa_BufferPtr(BrickInstanceAllocatorState)(as_address(brick_instance_allocator));
